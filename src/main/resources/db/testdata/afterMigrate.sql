...
(1, 'João da Silva', 'joao.sgodoy@hotmail.com', '123', utc_timestamp),
...
values (1, 'd7d362ea-d08c-46b5-825e-265588fba3b7', 1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
	                status, data_criacao, subtotal, taxa_frete, valor_total)
values (2, 'c18685e8-8834-45df-a797-d66e8e7c1a65', 4, 1, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro',
