...
//		Importante colocar o printStackTrace (pelo menos por enquando, que não estamos
//		fazendo logging) para mostrar a stacktrace no console
//		Se nao fizer isso, voce nao vai ver a stacktrace de exceptions que seriam 
//		importantes para voce durante, especialmente na fase de desenvolvimento.
		ex.printStackTrace();
...
//	1. MethodArgumentTypeMismatchExceptions é um subtipo de TypeMismatchException
//	2. ResponseEntityExceptionHandler ja trata TyeMismatchException de forma mais abrangente
//	3. Entao, especializamos o metodo handleTypeMismatch e verificamos se a exception
//	é uma instancia de MethodArgumentTypeMismatchException
//	4. Se for, chamamos um método espcioalista em tratar esse tipo de exception
//	5. Poderiamos fazer tudo dentro handleTypeMismatch, mas preferi separar em outro método
	@Override
...
//				.mensagem("Tipo de midia nao é aceito").build();
//		
