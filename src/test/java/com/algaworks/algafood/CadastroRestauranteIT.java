...
public class CadastroRestauranteIT {
	...
	@Test
	public void deveRestornarStatus400_QuandoCadastrarRestauranteSemTaxaFrete() {
	...
	@Test
	public void deveRestornarStatus400_QuandoCadastrarRestauranteSemCozinha() {
	...
	@Test
	public void deveRestornarStatus400_QuandoCadastrarRestauranteComCozinhaInexistente() {
	...
	@Test
	public void deveRestornarRespostaEStatusCorretos_QuandoConsultarRestauranteExistente() {
		given().pathParam("restauranteId", burguerTopRestaurante.getId()).accept(ContentType.JSON).when()
